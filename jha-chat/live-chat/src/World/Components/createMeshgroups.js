...
function createSphere(){
    ...
    //create mesh
    const sphere =new Mesh(geometry1, materialS);
...
function createBlob3(){
    const sphereGeometry = new SphereBufferGeometry(3,5,5,5)
...
export { createCube , createSphere, createBlob,createBlob2, createBackground,createBlob3,createBlob4};